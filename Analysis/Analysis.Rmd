...
knitr::include_graphics("data/initial_scatter_plot.png")
...
```{r,out.width="50%"}
 knitr::include_graphics("data/cp.png")
```
...
```{r}
# Plot K Values
knitr::include_graphics("data/K-value_plot.png")
```
...
```{r}
# Regression Plot
knitr::include_graphics("data/revenue_Budget_plot.png")
```
